...
import com.Hitsz.util.HttpUtil;
import com.Hitsz.util.Pkipair;
...
public class KuiQianService {
    ...
    public boolean addRecharge(Integer uid, BigDecimal rechargeMoney, String orderId) {
        ...
        record.setRechargeStatus(StandardConstant.RECHARGE_STATUS_PROCESSING);
