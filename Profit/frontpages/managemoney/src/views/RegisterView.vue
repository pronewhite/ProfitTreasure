          ...
          <form action="" id="register_Submit">
            <div class="alert-input">
              ...
              <input type="password" placeholder="请输入6-20位英文和数字混合密码" class="form-border user-pass"
                     v-model = "password" @blur = "checkPassword" autocomplete name="password">
            ...
            <div class="alert-input-btn">
              <input type="button" @click = "requestUserRegister" class="login-submit"  value="注册">
            </div>
          </form>
  ...
  methods:{
    checkPhone(){
      if (this.phone == '' || this.phone == undefined) {
        ...
        this.phoneErr = '';
        doGet('v1/user/phone/ifExist',{phone:this.phone}).then(resp =>{
    ...
    requestSmsCode() {
      ...
      if (this.isSend == false) {
        ...
        if (this.phoneErr == '') {
          ...
          //发起请求，给手机号发送验证码
          doGet('/v1/user/code/register', {phone: this.phone}).then(resp => {
