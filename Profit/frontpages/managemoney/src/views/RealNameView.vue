        ...
        <div class="login-box">
          ...
          <form action="" id="renZ_Submit">
            <div class="alert-input">
              <input type="text" class="form-border user-name" v-model = "name" @click = "checkName" name="username" placeholder="请输入您的真实姓名">
          ...
          <div class="login-skip">
            暂不认证？  <a href="javascript:;" @click="goLink('/page/user/center')">跳过</a>
          </div>
        </div>
